...
<body bgcolor="#ededed">
	<span><a href="/">Homepage</a></span><br/><br />
	<div id="top-div">
		<table id="form">
			<tr>
			...
			<tr>
				<td>Email Address</td>
				<td><input type="text" id="email_address" placeholder="adam@example.com"></td>
			</tr>
			<tr>
				<td>Mobile Number</td>
				<td><input type="text" id="mobile_number" placeholder="1234567890"></td>
			</tr>
			<tr>
				<td>Address Line 1</td>
				<td><input type="text" id="address_line_1" placeholder="Cecilia Chapman"></td>
			</tr>
			<tr>
				<td>Address Line 2</td>
				<td><input type="text" id="address_line_2" placeholder="Mankato Mississippi"></td>
			</tr>
			<tr>
				<td>State</td>
	...
	<div id="bottom-div">
		<h2 id="top">Customer Details</h2>
		<table width="100%" border="1" cellspacing="0" cellpadding="2" id="customerTable">
			<thead>
				<tr>
					<th>ID</th>
					<th>Name</th>
